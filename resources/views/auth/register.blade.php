        ...
        <div class="col-lg-6">
            <div class="card bg-transparent text-white shadow">
                <div class="card-body">
                    ...
                    <h2 class="text-center mb-4" style="font-family: 'Poppins', sans-serif; font-weight: 500; font-style: normal;">Register to SalonSEA</h2>
                    <form action="{{ route('register') }}" method="POST">
                        ...
                        <div class="mb-3 row justify-content-center">
                            <div class="col-10 col-sm-8 col-md-6">
                                ...
                                <input id="nomor_telepon" type="tel" autocomplete="off"
                                    class="form-control bg-transparent @error('nomor_telepon') is-invalid @enderror"
                        ...
                        <div class="row justify-content-center">
                            <div class="col-10 col-sm-8 col-md-6">
                                <button type="submit"
                                    class="btn btn-primary bg-transparent w-100 mt-3 hvr-bounce-to-right">{{ __('Register') }}</button>
                            </div>
                        </div>
                    </form>
                    <div class="text-center mt-3">
                        <a href="{{ route('login') }}" class="text-decoration-none text-primary">Already have an
